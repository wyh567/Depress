...
- **Result:** Workflow file is `.github/workflows/ci.yml`. PR #2 real GitHub-hosted `CI / Quality` succeeded on run `29174312356` at head `c67f85a1dca7590306f25134df8bb9b1a432499d` (`ubuntu-24.04`): frozen pnpm install, lint, typecheck, default tests, and build all passed. Opt-in Docker/Crossref/infrastructure smoke tests were not enabled by default. This does not claim branch protection, required status checks, CD, or deployment.
